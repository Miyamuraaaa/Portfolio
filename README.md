...
The sky now mounts once in the root layout, as a direct body sibling of the foreground wrapper. Its fixed inset-zero layer reaches every viewport edge and remains through the footer. There are 115 total desktop stars (70 distant, 35 medium, 10 near), or 28 static stars on tablet/mobile. One global meteor runs at most at a time: 6–14-second intervals in Hero/Journey and 12–25 seconds elsewhere, with 0.7–1.5-second flights. Three static radial gradients provide restrained violet, navy and champagne haze.
